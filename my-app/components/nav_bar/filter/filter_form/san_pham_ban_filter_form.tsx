    ...
    <div className='space-y-4 flex-col'>
      <div>
        ...
        <div className="flex space-x-2 items-center">
          <div className='flex btn gap-2 border-[1px] rounded-sm border-gray-600 bg-black hover:border-white p-2 cursor-pointer items-center' onClick={() => (document.getElementById('bla') as HTMLDialogElement)?.showModal()}>
            <img src="/img/icons/map.png" alt="" className='h-6'/>
            <p className='text-sm text-nowrap'>Bản đồ</p>
            <dialog id={'bla'} className="modal">
              <div className="modal-box absolute top-[12%] bg-gray-950 p-4 pb-8 max-w-2xl max-h-5xl h-auto">
                ...
                <div className="modal-action gap-0 justify-between mt-4">
                  <button className='btn bg-gray-800 w-[16%]'>Đặt Lại</button>
      ...
      <div>
        ...
        <DualRangeSlider dual_input_range_name='san_pham_ban_price' min={0} max={60000} step={500} type='san_pham_ban_price'/>
      </div>
      <div>
        <p className='text-sm my-1 ml-1'>4. Diện Tích</p>
        <DualRangeSlider dual_input_range_name='san_pham_ban_sqr' min={0} max={500} step={50} type='sqr'/>
      </div>
      <div>
