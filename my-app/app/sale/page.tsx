...
const FormSale = () => {
  ...
  return (
    <div className="p-6 max-w-4xl max-h-3xl my-0 md:my-12 px-0 md:px-4 mx-auto bg-gray-800 rounded-none md:rounded-xl shadow-md">
      <h1 className="text-2xl font-bold mb-6">Thông Tin Sản Phẩm</h1>
