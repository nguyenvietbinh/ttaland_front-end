...
const San_pham_ban_detail = ({ id }: San_pham_ban_details_props) => {
  ...
  const get_media_data_from_api = (apiData: Townhouse): MediaItem[] => {
    ...
    // Nếu không có media nào, thêm ảnh mặc định
  ...
  const convertApiDataToDetailInfor = (apiData: Townhouse): detail_infor => {
