...
import { get_price_per_square_meter, formatVietnameseNumber } from "../listing/show_property/san_pham_ban_show_property";
...
const San_pham_ban_detail = ({ id, table }: San_pham_ban_details_props) => {
        ...
        <div className="main_container">
          <div className="content_container flex flex-col gap-8">
            <div>
              ...
              <p className="text-xl text-gray-800">{propertyData?.detail_location || propertyData.location}</p>
            </div>
