...
const Du_an_sqr_option = () => {
  ...
  return (
    <div>
      <div ref={tagRef} onClick={() => {setShowOptions(preVal => !preVal)}} className="border-[1px] border-gray-400 backdrop-blur-3xl bg-white/10 p-1 px-4 flex gap-2 cursor-pointer hover:border-white rounded-sm">
...
export default Du_an_sqr_option