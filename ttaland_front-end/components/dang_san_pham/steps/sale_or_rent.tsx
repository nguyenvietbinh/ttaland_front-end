  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      <div className="flex gap-4 w-full">
        <div onClick={() => {setIsForSale(true); setIsForRent(false)}} className={`p-4 cursor-pointer border-1 border-gray-400 hover:border-gray-800 shadow-md hover:bg-gray-200 rounded-3xl w-full`}>
        ...
        <div onClick={() => {setIsForRent(true); setIsForSale(false)}} className={`p-4 cursor-pointer border-1 border-gray-400 hover:border-gray-800 shadow-md hover:bg-gray-200 rounded-3xl w-full`}>
