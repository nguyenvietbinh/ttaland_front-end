    ...
    <div className='space-y-4 flex-col'>
      <div>
        ...
        <div className="flex px-2 justify-between  items-center">
          ...
          <div className='flex btn gap-2 border-[1px] rounded-sm border-gray-600 bg-black hover:border-white p-2 cursor-pointer items-center' onClick={() => (document.getElementById('san_pham_ban_map') as HTMLDialogElement)?.showModal()}>
            <img src="/img/icons/map.png" alt="" className='h-6'/>
            <p className='text-base text-nowrap'>Bản đồ</p>
            <dialog id={'san_pham_ban_map'} className="modal">
